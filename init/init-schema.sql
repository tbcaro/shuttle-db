...
Insert into Stop
	...
	('1','David L Lawerence CoSSnvention Center','1000 Fort Duquesne Blvd, Pittsburgh, PA 15222',40.444927, -79.995739, False),
...
Insert into public.Assignment
	...
	Values
	  (1,4,1,1,'2017-01-28 05:30:00','Convention Center','SCHEDULED',false),
	  (1,5,2,2,'2017-01-28 05:30:00','Airport','SCHEDULED',false),
	  (1,5,2,1,'2017-01-28 07:30:00','Convention Center','SCHEDULED',false),
		(2,10,3,NULL,'2017-01-28 07:30:00','2017-01-28 07:45:00','SCHEDULED',false);

Insert into Assignment_Stop
	(AssignmentID, EstimatedTimeofArrival, EstimatedTimeofDeparture, TimeofArrival, TimeofDeparture, StopID, Address, Longitude, Latitude)
	Values
